...
import com.iqmsoft.spring.integration.IntegrationApp;
import com.iqmsoft.spring.integration.config.JmsTemplateConfig;
import com.iqmsoft.spring.integration.shop.flow.OrderFlows;
import com.iqmsoft.spring.integration.shop.model.*;
...
public class OrderFlowTest {
    ...
    public void testSimpleOrder() {
        ...
        assertThat(result.getTotalPrice()).isEqualByComparingTo(BigDecimal.valueOf(974L));
    }
    ...
    private Order order() {
        ...
        order.setItems(Arrays.asList(
        		...
        		buildMusicPlayer("iPod", BigDecimal.valueOf(150), 3))
        );
        return order;
    }

    private OrderItem buildMusicPlayer(String name, BigDecimal price, int count) {
        MusicPlayer mplayer = new MusicPlayer(name, price);
        return orderItem(mplayer, count);
    }
