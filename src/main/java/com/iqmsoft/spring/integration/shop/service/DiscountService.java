...
class DiscountService {
    ...
    private final static double MPLAYER_DISCOUNT = 0.8;
    ...
    public OrderItem addMPlayerDiscount(OrderItem orderItem) {
        LOGGER.info("Counting Music Player discount");
        BigDecimal priceAfterDiscount = calculateDiscount(orderItem, MPLAYER_DISCOUNT);
        orderItem.setPriceAfterDiscount(priceAfterDiscount);
        return orderItem;
    }
